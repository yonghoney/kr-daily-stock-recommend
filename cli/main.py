...
# Korean helpers: daily rule-based list (no LLM) + optional LLM analyze-kr
from cli.analyze_kr import register as _register_analyze_kr
from cli.daily_recommend import register as _register_daily_recommend

_register_daily_recommend(app)
_register_analyze_kr(app)
